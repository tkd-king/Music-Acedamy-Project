  ...
  return (
    <div className="h-auto md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center overflow-hidden relative mx-auto py-10 md:py-0 ">
      ...
      <div className="p-4 relative z-10 w-full text-center">
        <h1 className="mt-20 md:mt-0 text-4xl md:text-7xl font-bold bg-clip-text text-white text-neutral-200 bg-graidient-to-b from-neutral-50 to-neutral-400">
          Master the art of music
        </h1>
        <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae odio
          labore, nostrum nam consequuntur unde ducimus? Qui hic{" "}
        </p>
        <div className="mt-4">
          <Link href="#courses">
            <Button
